...
trait html {
	...
	static function thead($content, $opt=null){
		return "<thead $opt>$content</thead>";
	}

	static function tbody($content, $opt=null){
		return "<tbody $opt>$content</tbody>";
	}
	...
	//icone onglet
	static function icon_file($file){
		return '<link rel="icon" type="image/png" href="'.IMG.$file.'.ico"/>';
	}	

	//CSS
	static function css_file($file){
		/*return '<style href="'.CSS.$file.'.css" rel="stylesheet" media="all" type="text/css">';*/
		return '<link href="'.CSS.$file.'.css" rel="stylesheet" />';
	}
	...
	//JavaScript
	static function script_file($file){
